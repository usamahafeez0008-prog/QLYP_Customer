...
class HomeScreen extends StatelessWidget {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  // Γ£à use ValueListenableBuilder output if provided
                  valueWidget ??
                      Text(
                        value ?? "",
                        maxLines: 1,
        ...
        return Scaffold(
          ...
          body: controller.isLoading.value
            ...
            children: [
              ...
              // Γ£à Small dark overlay for contrast
              Positioned.fill(
                child: Container(
              ...
              // Γ£à ONE scrollable card (bottom sheet style)
  ...
  /// Γ£à THIS IS A CLASS METHOD (no more "referenced before declared" issue)
      ...
      children: [
        ...
        Obx(() {
          ...
          if (!hasSource) {
            return InkWell(
              onTap: () async {
                // Γ£à SAME LOGIC AS YOUR OLD CODE (copied exactly)
                print("::::::::::22::::::::::::");
        ...
        // Γ£à Price summary (same logic, styled)
        Obx(() {
        ...
        // Γ£à Offer rate input (same widget, themed cursor)
        Visibility(
          visible: controller
              .selectedType
              .value
        ...
        // Γ£à Book Ride button (same onPress logic)
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          // Optional little connector bump (creates that ΓÇ£joinedΓÇ¥ look)
          Positioned(
            left: 72,
            child: Container(
              width: 28,
...
/*
  ...
  Widget build(BuildContext context) {
    ...
    // Γ£à height of the top area where map should appear
      ...
      builder: (controller) {
        return Scaffold(
          ...
          body: controller.isLoading.value
            ...
            children: [
              // ============================================================
              // Γ£à 1) MAP IN BACKGROUND (TOP AREA) - MUST BE FIRST CHILD
              // ============================================================
              Positioned(
                top: 0,
                left: 0,
              ...
              // Γ£à Optional: soft dark overlay on map to match theme
              Positioned(
                top: 0,
                left: 0,
                right: 0,
              ...
              // ============================================================
              // Γ£à 2) GRADIENT BG BELOW MAP ONLY (so map stays visible!)
              // ============================================================
              Positioned.fill(
                child: Column(
                  children: [
              ...
              // ============================================================
              // Γ£à 4) MAIN CONTENT (STARTS BELOW MAP)
              // ============================================================
              SafeArea(
                child: Column(
                  children: [
                    // Γ£à push content below the map area
...
/* {
                                  ...
                                  return Obx(
                                        ...
                                        return InkWell(
                                          onTap: () {
                                            controller.selectedServiceCategory.value = item["title"]!;
                                            // Γ£à keep only UI selection OR call your filter logic here
                            ...
                            // Γ£à Service list (same selection logic, QLYP look)
                            SizedBox(
                              height: Responsive
                                  .height(
                                  18,
                                      ...
                                      controller.sourceLocationLAtLng.value.latitude == null
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            InkWell(
                                              onTap: () async {
                                                // Γ£à SAME SOURCE onTap logic (copied exactly)
                                                print("::::::::::33::::::::::::");
                                                if (Constant.selectedMapType == 'osm') {
                                                  final result = await Get.to(() => MapPickerPage());
                                                  if (result != null) {
                                            ...
                                            InkWell(
                                              onTap: () async {
                                                // Γ£à SAME DESTINATION onTap logic (copied exactly)
                                                print("::::::::::11::::::::::::");
                                                if (Constant.selectedMapType == 'osm') {
                                                  final result = await Get.to(() => MapPickerPage());
                                                  if (result != null) {
