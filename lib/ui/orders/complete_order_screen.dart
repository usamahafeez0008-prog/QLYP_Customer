                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: Column(
                                                                children: [
                                                                  ...
                                                                  SizedBox(
                                                                    height: controller.orderModel.value.service?.prices?.first.isAcNonAc ==
                                                                            false
                                                                        ? 0
                                                                        : 10,
                                                                  ),
                                                  ...
                                                  if (controller.holdingCharge
                                                    ...
                                                    Row(
                                                      children: [
                                                        Expanded(
                                                          child: Text(
                                                            "Holding Charge (${controller.orderModel.value.rideHoldTimeMinutes ?? '0'} Minutes)"
                                                                .tr,
                                                            style: GoogleFonts.poppins(
                                                                color: AppColors
                                                                    .subTitleColor),
